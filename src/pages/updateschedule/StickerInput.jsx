...
import { __coverShow, __stickerInfo, __stickerShow } from '../../modules/update';
...
const StickerInput = () => {
  ...
  const stickerShow = useSelector((state) => state.update.stickerShow);
                  ...
                  {stickerNum === '1' && (
                    <StickerPick1 htmlFor='1' sticker={sticker}>
                      <Input
                        ...
                        sticker={sticker}
                        defaultCheked={stickerNum === String(detail?.sticker)}
                      />

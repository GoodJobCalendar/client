...
import { __colorInfo, __colorPickerShow } from '../../modules/update';

const ColorInput = () => {
  const dispatch = useDispatch();
  const detail = useSelector((state) => state.schedule.detail);
  const colorPickerShow = useSelector((state) => state.update.colorPickerShow);
  ...
  const [colorPick, setColorPick] = useState(changeColor(color));
            ...
            return (
              <>
                <Input
                  ...
                  name='color'
                  id={colorNum.num}
                  value={colorNum.color}
                  onChange={colorChange}
                  defaultCheked={colorNum.num === String(detail?.color)}
                />
